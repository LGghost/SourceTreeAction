...
public class TheLibraryAityity extends BaseActivity implements OrderEasyView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StockAdapter(this, 1);
    ...
    void search() {
        ...
        Intent intent = new Intent(TheLibraryAityity.this, SearchGoodsActivity.class);
        //利用bundle来存取数据
    ...
    private void showdialogs() {
        ...
        queren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                delivery.setOperate_type(Config.Operate_TYPE_CHUKU);
                ...
                ProgressUtil.showDialog(TheLibraryAityity.this);
    ...
    void saoyisao() {
        if (SystemfieldUtils.isCameraUseable()) {
            Intent intent = new Intent(TheLibraryAityity.this, ScanActivity.class);
