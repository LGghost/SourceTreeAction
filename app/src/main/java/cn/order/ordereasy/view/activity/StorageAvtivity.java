...
public class StorageAvtivity extends BaseActivity implements OrderEasyView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StockAdapter(this, 0);
    ...
    void search() {
        ...
        Intent intent = new Intent(StorageAvtivity.this, SearchGoodsActivity.class);
        //利用bundle来存取数据
    ...
    private void showdialogs() {
        ...
        queren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                delivery.setOperate_type(Config.Operate_TYPE_RUKU);
                ...
                ProgressUtil.showDialog(StorageAvtivity.this);
    ...
    void saoyisao() {
        if (SystemfieldUtils.isCameraUseable()) {
            Intent intent = new Intent(StorageAvtivity.this, ScanActivity.class);
