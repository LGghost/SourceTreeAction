...
/**
 * Created by Mr.Pan on 2017/4/20.
 */
...
public class HorizontalScrollTabStrip extends HorizontalScrollView {
    ...
    /** 激活时颜色 */
    private Integer mActiveColor = Color.RED;

    /** 默认颜色 */
    private Integer mDefaultColor = Color.BLACK;
    ...
    protected void changeActiveTag(int position) {
        ...
        /*Toast.makeText(getContext(), mTitles.get(position), Toast.LENGTH_SHORT)
                .show();*/
        /** 当前控件索引 */
        mTagIndex = -1;
        ...
        if (null != mListener) {
            if (motionLength == 0) {
                mListener.changeLine(location[0],true,mTagIndex);
            } else {
                mListener.changeLine(location[0] - motionLength,true,mTagIndex);
            }
        }
    ...
    public interface TagChangeListener {
         ...
         */
        void changeLine(int location_x, boolean isClick, int position);
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (isScrool) {
            ...
            if (null != mListener) {
                mListener.changeLine(location[0],false,mTagIndex);
            }
        }
