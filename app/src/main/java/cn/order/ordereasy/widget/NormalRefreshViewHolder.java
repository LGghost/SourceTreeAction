 ...
 * 描述:类似新浪微博下拉刷新风格
 */
public class NormalRefreshViewHolder extends BGARefreshViewHolder {
    ...
    private String mRefreshingTimeText="上次刷新时间：";
    private String mRefreshingTime="";
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            mRefreshHeaderView = View.inflate(mContext, cn.bingoogolapple.refreshlayout.R.layout.view_refresh_header_normal, null);
    ...
    public void onEndRefreshing() {
        ...
        mRefreshingTime = "\n上次刷新时间："+sdf.format(new Date());
        mHeaderStatusTv.setText(mPullDownRefreshText+mRefreshingTime);
        mHeaderChrysanthemumIv.setVisibility(View.INVISIBLE);
        mHeaderChrysanthemumAd.stop();
        mHeaderArrowIv.setVisibility(View.VISIBLE);
