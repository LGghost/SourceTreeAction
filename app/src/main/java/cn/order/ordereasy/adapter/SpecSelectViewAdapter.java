...
public class SpecSelectViewAdapter extends BGAAdapterViewAdapter<Map<String,Object>> {
    /**
     * 当前处于打开状态的item
     */
    private List<BGASwipeItemLayout> mOpenedSil = new ArrayList<>();

    public SpecSelectViewAdapter(Context context) {
        super(context, R.layout.item_select_spec);
    }
    ...
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, Map<String,Object> model) {
        ...
        ImageView imageView =viewHolderHelper.getImageView(R.id.fenlei_edit);
        ...
        if(model.get("isChecked").equals("1")){
            ...
            imageView.setVisibility(View.GONE);
            checkBox.setVisibility(View.VISIBLE);
        }else if(model.get("isChecked").equals("0")){
