...
public class AllTradeAdapter extends BaseAdapter {
    public List<Trade> lists = new ArrayList<>();
    public Context context;

    public AllTradeAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (my != null) {
            ...
            holder.all_sales.setText("销售量：" + my.getSale_num());
            allTradeChildAdapter adapter = new allTradeChildAdapter(context);
