...
public class Config {
     ...
     * 供应商应付款调整
     */
    public final static String supplier_accountLogAdjust_url = "supplier/accountLogAdjust";

    /**
     * 向供应商付款
     */
    public final static String supplier_pay_url = "supplier/pay";

    /**
     * 开采购单
     */
    public final static String supplier_addOrder_url = "supplier/addOrder";

    /**
     * 采购订单列表
     */
    public final static String supplier_orderList_url = "supplier/orderList";

    /**
     * 采购订单列表
     */
    public final static String supplier_orderInfo_url = "supplier/orderInfo";

    /**
     * 采购订单列表
     */
    public final static String supplier_orderClose_url = "supplier/orderClose";

    /**
     * 对账列表
     */
    public final static String supplier_accountLog_url = "supplier/accountLog";

    /**
     * 未入库列表
     */
    public final static String supplier_waitInStore_url = "supplier/waitInStore";

    /**
     * 未入库列表
     */
    public final static String supplier_goInStore_url = "supplier/goInStore";

    /**
     * 删除供货商
     */
    public final static String supplier_del_url = "supplier/del";
